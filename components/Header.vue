<template>
  <div class="d-flex align-items-center justify-content-sm-center" style="height: 80px; padding: 10px 5vw">
    <img src="/img/logo.svg" alt="" style="height: 60px" />
    <img src="/img/title.svg" alt="中国汉服文化网" style="height: 40px; margin-left: 12px" />
